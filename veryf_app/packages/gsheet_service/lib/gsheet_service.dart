...
class GSheetService {
  static const _credentials = r'''
    ...
    ''';
  static const _spreadsheetId = "1-0JKVifASP3dbhVYOdJGpw-TtO4QEZNtg6OLDfhTGHM";
  List<String> headers;
  String worksheetTitle;
  late GSheets gSheets;
  late Worksheet worksheet;

  GSheetService(this.worksheetTitle, this.headers) {
    init();
  }
  ...
  Future init() async {
    ...
    try {
      ...
      worksheet = await _getWorkSheet(spreadsheet, title: worksheetTitle);
      worksheet.values.insertRow(1, headers);
    } on Exception catch (e) {
      print("Init Error: $e");
    }
    print("GSheet Service initialized!");
  }
}
